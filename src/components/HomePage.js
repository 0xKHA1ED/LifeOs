      ...
      <div className="max-w-4xl w-full">
        ...
        {user ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link to="/notes-app" className="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out transform hover:-translate-y-1">
              <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">Notes</h2>
              <p className="text-gray-600 dark:text-gray-400">Capture your thoughts.</p>
            </Link>
          </div>
        ) : (
          <button
