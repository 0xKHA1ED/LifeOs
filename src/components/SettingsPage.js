  ...
  return (
    <div id="settings-page" className="page">
      <header className="sticky top-0 z-10 flex items-center justify-between bg-background-light/80 p-4 pb-2 backdrop-blur-sm dark:bg-background-dark/80">
        <div className="w-12">
          <button className="nav-link flex h-10 w-10 cursor-pointer items-center justify-center rounded-full text-gray-900 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" data-page="dashboard">
      ...
      <main className="p-4 space-y-6">
        <div className="p-4 bg-card-light dark:bg-card-dark rounded-xl">
          ...
          <div id="user-info-container" className="text-center">
            {loading ? (
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Connecting...</p>
            ) : user ? (
              <>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Signed in as: {user.email}</p>
                <button onClick={signOutUser} id="sign-out-btn" className="w-full rounded-lg bg-gray-200 py-2.5 px-4 font-semibold text-gray-800 shadow-sm hover:bg-gray-300 dark:bg-gray-600 dark:text-white dark:hover:bg-gray-500">Sign Out</button>
              </>
            ) : (
              <>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">You are not signed in.</p>
        ...
        <div className="p-4 bg-card-light dark:bg-card-dark rounded-xl">
          <h2 className="font-bold mb-2">Appearance</h2>
